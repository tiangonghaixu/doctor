...
class RedisHelper(object):
    ...
    def __init__(self, r_cfg=None, w_cfg=None):
        ...
        # self.check_r_conn_timer = Timer(CONN_CHECK_INTERVAL, self.check_r_conn)
        # self.check_w_conn_timer = Timer(CONN_CHECK_INTERVAL, self.check_w_conn)
        # self.check_r_conn_timer.start()
        # self.check_w_conn_timer.start()
    ...
    def hexists(self, name, key):
        ...
        try:
            return self.r.hexists('HEXISTS', name, key)
        except Exception, ex:
            self.is_w_working = False
            return None
...
redis_conn = RedisHelper(get_redis_conf('doctor_redis_read'), get_redis_conf('doctor_redis_write'))
celery_broker_redis_conn = RedisHelper(get_redis_conf('doctor_celery_redis'), get_redis_conf('doctor_celery_redis'))
